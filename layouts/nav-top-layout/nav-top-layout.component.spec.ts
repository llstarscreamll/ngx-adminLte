...
describe('AdminLTE NavTopLayoutComponent', () => {
  ...
  it('should hide/show user menu', fakeAsync(() => {
    ...
    const userMenuSelector = 'app-user-menu';
    let userMenu;
    ...
    const loginLink = fixture.debugElement.query(By.css('a.login-link'));
    const signUpLink = fixture.debugElement.query(By.css('a.sign-up-link'));
  ...
  it('should show the App name on page header', fakeAsync(() => {
    ...
    const appNameElem = fixture.debugElement.query(By.css('div.navbar-header .navbar-brand'));
